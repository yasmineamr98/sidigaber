...
@section('title', 'Add New Raw Meat')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h2 class="mb-0">Add New Raw Meat</h2>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('raw-meats.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('quality') is-invalid @enderror" 
                                        id="quality" name="quality">
                                    <option value="standard" {{ old('quality') == 'standard' ? 'selected' : '' }}>Standard</option>
                                    <option value="premium" {{ old('quality') == 'premium' ? 'selected' : '' }}>Premium</option>
                                    <option value="economy" {{ old('quality') == 'economy' ? 'selected' : '' }}>Economy</option>
                                </select>
                                @error('quality')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-primary">Add Raw Meat</button>
